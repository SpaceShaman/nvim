return function()
  ...
  map('n', '<Leader>j', '<Cmd>WinShift left<CR>', { desc = 'Move window to far lower', noremap = true })
  map('n', '<Leader>k', '<Cmd>WinShift down<CR>', { desc = 'Move window to far lower', noremap = true })
  map('n', '<Leader>l', '<Cmd>WinShift up<CR>', { desc = 'Move window to far upper', noremap = true })
  map('n', '<Leader>;', '<Cmd>WinShift right<CR>', { desc = 'Move window right', noremap = true })
